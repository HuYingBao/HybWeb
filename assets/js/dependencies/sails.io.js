    ...
    return function e(t, n, r) {
        ...
        3: [function (_dereq_, module, exports) {
            ...
            Manager.prototype.packet = function (packet) {
                ...
                if (!self.encoding) {
                    self.encoding = true;
                    this.encoder.encodeApp(packet, function (encodedPackets) {
            ...
            (function (global) {
                ...
                exports.encodePacket = function (packet, supportsBinary, utf8encode, callback) {
                    ...
                    if (undefined !== packet.data) {
                        encoded += utf8encode ? utf8.encodeApp(String(packet.data)) : String(packet.data)
                    }
        ...
        29: [function (_dereq_, module, exports) {
            (function (chars) {
                "use strict";
                exports.encodeApp = function (arraybuffer) {
        ...
        31: [function (_dereq_, module, exports) {
            (function (global) {
                (function (root) {
                    ...
                    var utf8 = {version: "2.0.0", encodeApp: utf8encode, decode: utf8decode};
        ...
        33: [function (_dereq_, module, exports) {
            exports.encodeApp = function (obj) {
                var str = "";
                for (var i in obj) {
                    if (obj.hasOwnProperty(i)) {
                        if (str.length) str += "&";
        ...
        44: [function (_dereq_, module, exports) {
            ...
            Encoder.prototype.encodeApp = function (obj, callback) {
